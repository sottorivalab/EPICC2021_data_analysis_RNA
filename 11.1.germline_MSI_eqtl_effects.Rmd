...
## Run PCA on germline SNPs matrix - Figure S20
...
pdf('figures/figS20.germline_PCA.MSI.pdf')
print(p)
dev.off()

q <- p + xlim(0.2,0.5) + ylim(-0.1,0.3)
pdf('figures/figS20.germline_PCA.MSI.ZOOM.pdf')
print(q)
dev.off()
```
...
## Compare results of MSS-only and MSI-only eQTL analyses - Figure S21
...
pdf('figures/figS21.qqplot_mss_vs_msi.pdf')
