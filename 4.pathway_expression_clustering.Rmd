...
## Plot clustering results (Figure S3 A-C)
```{r plot_clustering}
...
pdf('figures/figS3A.expression.pathway.pdf',height=8,width=4)
...
pdf('figures/figS3A.standarddeviation.pathway.pdf',height=7.5,width=5)
...
# Exploring Group
pdf('figures/figS3BC.exploring_groups.pathway.pdf',width=4,height=4)
groupdf <- pathdf
...
## Perform and plot fishers test on pathway groups vs classes (Figure S3D)
...
pdf('figures/figS3D.fisher_tests_group_vs_class.pdf',height=8,width=6)
options(scipen=-2)
