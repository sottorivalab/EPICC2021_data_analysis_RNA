...
```{r library}
library(data.table);library(dplyr);library(DESeq2);library(scales);library(stringr);library(MASS);library(rms)
```
...
filgenres <- readRDS('input_files/gene_clustering_and_id_conversion.rds')
...
saveRDS(listmat,'results/eqtl_data_matrices.rds')
