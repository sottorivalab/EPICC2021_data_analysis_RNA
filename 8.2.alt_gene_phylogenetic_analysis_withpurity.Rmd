...
pdf('figures/figS8AB.lambda_analysis_genes.purity.pdf',height=8,width=5)
for(pat in tinfo$patients) {
...
pdf('figures/figS8C.recurrent_genes_lambda.purity.pdf',height=13,width=8.5)
...
pdf('figures/figS8D.gene_phylo_chiplot.purity.pdf')
...
pdf('figures/figS8E.phylo_vst_vs_lognorm.perc.pdf')
...
pdf('figures/figS8F.phylo_vst_vs_lognorm.shared.pdf',width=8)
