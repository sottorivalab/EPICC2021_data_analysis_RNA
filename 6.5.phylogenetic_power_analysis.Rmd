---
title: "Perform post hoc power analysis of phylogenetic analysis"
...
# Run runphylo 1000 times, and get power (proprtion of iterations that were significant)
...
# Plot Figure 3A
pdf('figures/example_tree.pdf',width=8)
...
for(pat in tinfo$patients) {
  ...
  # Plot Figure S4 A-H
  pdf(paste0('figures/power_sim_100_median.',pat,'.pdf'),width=9)
