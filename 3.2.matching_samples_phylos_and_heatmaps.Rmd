...
## Plot DNA phylogenies as dendrograms, clusterred heatmaps and get tanglegram statistics
### Figure S11 (deconstructed)
```{r plot_dna_get_stats}
cophcors <- c()
pdf('figures/figS11.expressed_dnatree_expclust_tangles.pdf',height=8,width=5)
